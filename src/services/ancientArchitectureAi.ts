...
export const ARCHITECTURE_PAGE_CONTEXTS: ArchitecturePageContext[] = [
  ...
  },
  {
    path: '/bridge',
    name: '桥梁抗震',
    summary: '桥梁抗震模块以赵州桥为核心，按论文结论展示低矢跨比圆弧主拱、敞肩小拱、28道并列拱券、桥台水平推力与受压主导的石拱受力逻辑。',
    prompts: ['赵州桥为什么能让恒载压力线更贴近拱轴？', '敞肩小拱在减重、泄洪和受力优化上各起什么作用？', '为什么不能把赵州桥解释成现代隔震桥？'],
    keywords: ['赵州桥', '桥梁', '抗震', '受力', '敞肩拱', '压力线', '拱脚'],
  },
  {
    path: '/palace',
    name: '皇宫游览',
